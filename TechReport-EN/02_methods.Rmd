...
The fishing platform used (the vessel and the type of fishing gear) has changed a number of times since the onset of sampling activities [@ClarkEmberley2011]. Comparative fishing experiments were conducted when those changes in survey platforms took place [@Koeller-Smith-1983;@Fanning-1984;@Fowler-Showell-2009]. The A.T. Cameron using a Yankee 36 trawl was the primary survey vessel from 1970 to 1981. The vessel that was then built to replace the A.T. Cameron to conduct trawl surveys (CCGS Alfred Needler) was not yet operational and the Lady Hammond was used to bridge the gap between the A.T. Cameron and the CCGS Alfred Needler. A change to the Western IIA trawl also took place after A.T. Cameron was retired. The CCGS Alfred Needler entered service for the 1983 summer survey using a Western IIA trawl. It has been the main survey platform since. The CCGS Alfred Needler suffered a fire in 2003 and the CCGS Teleost was used instead. In 2007, 2008 and 2018 the CCGS Alfred Needler was not available and the survey was conducted on the CCGS Teleost in 2007 and 2018, and on the CCGS Wilfred Templeman in 2008. The relevant details of the survey vessels [@Maginley-etal-2014] and fishing trawls used can be found in Table \@ref(tab:vesselandgear) and a timeline of the survey platforms can be found in Figure \@ref(fig:timeline).
...
\toprule
\multicolumn{3}{l}{Survey vessels}\\
\midrule
\bfseries{Name} & \bfseries{Measurements} & \bfseries{Description} \\
\midrule
A.T. Cameron & Length: 40m & \\
Lady Hammond & Length: 40m & \\
& Gross tonnage: 897 t & \\
\link{https://inter-j01.dfo-mpo.gc.ca/fdat/vessels/2}{CCGS Alfred Needler} & Length: 50.3m & Main survey vessel since 1983 \\
& Gross tonnage: 959 t & \\
\link{https://en.wikipedia.org/wiki/CCGS_Wilfred_Templeman}{CCGS Wilfred Templeman} & Length: 50.3m &  Sister ship of CCGS Alfred Needler, used in 2008 \\
& Gross tonnage: 959 t & \\
\link{https://inter-j01.dfo-mpo.gc.ca/fdat/vessels/107}{CCGS Teleost} & Length: 63.0m & Used in 2007 and 2018\\
& Gross tonnage: 2,405.0 t & \\
\bottomrule
\multicolumn{3}{l}{Fishing trawls}\\
\midrule
\bfseries{Name} & \bfseries{Measurements} & \bfseries{Description} \\
\midrule
Yankee 36 & Width: 10.7m & \\
Western IIA & Width: 12.5m & Used since 1983\\
\bottomrule
\end{tabular}
