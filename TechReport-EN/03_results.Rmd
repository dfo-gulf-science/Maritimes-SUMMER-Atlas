...
(ref:setsdistcap) Cumulative frequency distribution of depth, bottom temperature and bottom salinity of representative sets from the summer survey. 

```{r setsdist, fig.cap="(ref:setsdistcap)"}
knitr::include_graphics("./figures/summer-depth-CDF.png")
```
