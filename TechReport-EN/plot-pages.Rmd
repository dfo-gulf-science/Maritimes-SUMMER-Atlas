...
\end{tabular} 
\captionof{figure}{DDHS slopes versus median stratum abundance. The last two digits of each stratum number is shown in the figure for Piked dogfish. The red box indicates strata of particular importance for a species by identifying slopes that are within a standard error from zero and that are within the top 25\% of median abundance.}
\end{minipage} 
...
\begin{minipage}{1.0\textwidth}
 \begin{tabular}{ccc}
\includegraphics[width=2.0in]{../Figures-Actual/RV-4VWX-880-stratifiedB.pdf} & 
\includegraphics[width=2.0in]{../Figures-Actual/RV-4VWX-880-distribution-indices-usingB.pdf} & 
\includegraphics[width=2.0in]{../Figures-Actual/RV-4VWX-880-BvsD75corr.pdf} \\ 
\end{tabular} 
...
Scientific name: [Agonidae](https://www.marinespecies.org/aphia.php?p=taxdetails&id=125588) 
 \newline
\begin{minipage}{1.0\textwidth}
 \begin{tabular}{c}
