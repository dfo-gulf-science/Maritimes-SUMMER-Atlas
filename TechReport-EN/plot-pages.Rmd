...
## Greenland halibut (Flétan du Groënland) - species code 31 (category LIn) {#sec:31} 

\index{Flétan du Groënland} \index{Greenland halibut} \index{Reinhardtius hippoglossoides} 
...
## Blackbelly rosefish (Sébaste chèvre) - species code 123 (category LIn) {#sec:123} 
...
## Atlantic butterfish (Stromatée à fossettes) - species code 701 (category LIn) {#sec:701} 

\index{Stromatée à fossettes} \index{Atlantic butterfish} \index{Peprilus triacanthus} 
...
## Jonah crab (Crabe nordique) - species code 2511 (category SF) {#sec:2511} 

\index{Crabe nordique} \index{Jonah crab} \index{Cancer borealis} 
...
## Atlantic rock crab (Crabe commun) - species code 2513 (category SF) {#sec:2513} 

\index{Crabe commun} \index{Atlantic rock crab} \index{Cancer irroratus} 
...
\index{Eperlan arc-en-ciel@Éperlan arc-en-ciel} \index{Rainbow smelt} \index{Osmerus mordax} 
...
\index{Eperlan du large@Éperlan du large} \index{Shortnose greeneye} \index{Chlorophthalmus agassizi} 
