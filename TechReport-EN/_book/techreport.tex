...
\caption{Timeline of vessels and gears used in the Maritimes Region summer survey. The y axis identifies the vessel used and the gear used is overlaid on the polygon representing the time window where each vessel was used.}\label{fig:timeline}
\end{figure}
