...
\newcommand{\trResume}{Le relevé estival par navires de recherche sur le poisson de fond sur le plateau néo-écossais et dans la baie de Fundy a débuté en 1970 et visait à mesurer la répartition et l'abondance des principales espèces de poissons commerciales. Au fil du temps, des informations supplémentaires sur les espèces non commerciales ont été recueillies et ont permis de mieux comprendre la fonction et la structure de l'écosystème, comme le montrent de nombreuses publications primaires dont les analyses ont utilisé les données des relevés. La même base de données sur les relevés du poisson de fond a également été utilisée pour produire des rapports sur la situation des espèces, des atlas de la répartition des espèces et demeure une source essentielle d'information pour les évaluations des stocks dans la région des Maritimes de Pêches et Océans Canada. Ce rapport s'appuie sur des travaux antérieurs et d'anciens atlas en mettant à jour une série complète d'indices pour évaluer l'état de la population et les préférences environnementales de 104 espèces. Pour chaque espèce, les tendances de la répartition géographique et de la biomasse ou de l'abondance ont été tracées. L'étendue spatiale de la distribution a été tracée au fil du temps pour évaluer comment la zone occupée a changé. La relation entre l'abondance ou la biomasse et l'étendue spatiale indique si la répartition des espèces augmente lorsque l'abondance ou la biomasse augmente. Les fréquences de longueur au fil du temps représentaient tout changement dans la taille moyenne. Les graphiques de l'état au fil du temps ont révélé si les poissons individuels sont plus gros ou plus minces que leur moyenne à long terme. Les préférences en matière de profondeur, de température et de salinité ont été estimées pour évaluer la gamme de paramètres environnementaux appropriés pour chaque espèce. Enfin, pour chaque strate, la pente décrivant comment la densité locale varie avec l'abondance régionale a été estimée.}
...
A number of changes in fishing gear type and vessels used occurred since the onset of sampling activities (\protect\hyperlink{ref-ClarkEmberley2011}{Clark and Emberley 2011}). Comparative fishing experiments were conducted when those changes in survey platforms took place.
...
\toprule
 & Stratum & Depth range (fathom) & Area (km \textsuperscript{2})\\
\midrule
\endfirsthead
\caption*{}\\
\toprule
...
\endlastfoot
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{4Vn}}\\
\hspace{1em} & 440 & 101-200 & 924\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 441 & 51-100 & 1000\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 442 & 0-49 & 1437\\
\cmidrule{1-4}\pagebreak[0]
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{4VsW}}\\
\hspace{1em} & 443 & 0-49 & 1318\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 444 & 51-100 & 3925\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 445 & 101-200 & 1023\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 446 & 101-200 & 491\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 447 & 0-49 & 1616\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 448 & 0-49 & 1449\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 449 & 51-100 & 144\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 450 & 51-100 & 383\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 451 & 101-200 & 147\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 452 & 101-200 & 345\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 453 & 101-200 & 259\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 454 & 51-100 & 499\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 455 & 0-49 & 2122\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 456 & 0-49 & 955\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 457 & 51-100 & 811\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 458 & 0-49 & 658\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 459 & 0-200 & 3148\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 460 & 51-100 & 1344\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 461 & 101-200 & 1154\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 462 & 51-100 & 2116\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 463 & 0-49 & 302\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 464 & 0-50 & 1297\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 465 & 51-100 & 2383\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 466 & 101-200 & 226\\
\cmidrule{1-4}\pagebreak[0]
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{4X}}\\
\hspace{1em} & 470 & 51-100 & 920\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 471 & 101-200 & 1004\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 472 & 51-100 & 1249\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 473 & 0-49 & 265\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 474 & 0-49 & 161\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 475 & 0-49 & 156\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 476 & 51-100 & 1478\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 477 & 51-100 & 1232\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 478 & 101-200 & 233\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 480 & 0-49 & 655\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 481 & 51-100 & 1875\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 482 & 101-200 & 1042\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 483 & 101-200 & 532\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 484 & 101-200 & 2264\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 485 & 51-100 & 1582\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 490 & 0-49 & 601\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 491 & 51-100 & 687\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 492 & 51-100 & 1086\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 493 & 0-49 & 533\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 494 & 0-49 & 417\\
\cmidrule{2-4}\nopagebreak
\hspace{1em} & 495 & 0-49 & 584\\*
\end{longtable}
...
\begingroup\fontsize{7}{9}\selectfont
\begin{longtable}[t]{crrrrrrrrrrrrrrrcrrrrrr}
\caption{\label{tab:tabtowstratumyear1}Number of representative tows conducted in each stratum during the period 1990 to 2009.}\\
\toprule
...
\caption{\label{tab:tabtowstratumyear1}Number of representative tows conducted in each stratum during the period 2010 to 2020 and for the whole 1970 to 2020 period.}\\
\toprule
...
W., G.B.J., Shackell, N.L., Ferguson, K., P., G., Cogswell, A., Brickman, D., Wang, Z., Cook, A., Brennan, C.E., and Saba, V.S. 2019. Climate change vulnerability of {A}merican lobster fishing communities in {A}tlantic {C}anada. Frontiers in Marine Science 6: 579.
