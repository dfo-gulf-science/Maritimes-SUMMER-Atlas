...
For each species, stratified random estimates of catch biomass (\protect\hyperlink{ref-Smith:1996}{Smith 1996}) were computed for each year. Yearly estimates of the standard error were also computed.
...
{\centering \pdftooltip{\includegraphics[width=6in]{./figures/temp}}{Figure \ref{fig:setsdist}} 

}

\caption{Cumulative frequency distribution of depth, bottom temperature and bottom salinity of representative sets from the summer survey.}\label{fig:setsdist}
\end{figure}
